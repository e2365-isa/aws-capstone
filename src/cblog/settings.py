...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/cess/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/cess/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.clo02mec6swa.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones-cess-blog' # please enter your s3 bucket name
